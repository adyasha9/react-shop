            ...
            <Container>
                <div>
                    ...
                    <div className="row product-list">
                        { 
                           products.length ? products.map( product => <Product key={ product.id } data={ product } renderItem={({ item }) => <Product item={item.name} id={item.id} />}  keyExtractor={item => item.id.toString()}/>) : <span>Product Loading...</span>
